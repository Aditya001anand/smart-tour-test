  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative', zIndex: 1, paddingBottom: '40px' }}>
      ...
      <main style={{ maxWidth: '1000px', margin: '40px auto 0', padding: '0 24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="bg-white border-l-4 border-red-500 shadow-lg p-8 rounded-2xl animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
            <div style={{ fontSize: '1.8rem' }}>🚨</div>
            <h2 style={{ fontSize: '1.8rem', color: '#0f172a', fontWeight: 800, margin: 0 }}>Emergency SOS Contact</h2>
          </div>
          <p style={{ marginBottom: '24px', fontSize: '1.05rem', color: '#475569' }}>
            This number will automatically receive an SMS alert with your live GPS coordinates if you trigger the SOS.
          </p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
            <input 
              ...
              style={{
                flex: 1, minWidth: '250px', padding: '12px 20px', fontSize: '1.1rem',
                borderRadius: '8px', border: '1px solid #cbd5e1', color: '#0f172a',
            ...
            <button 
              ...
              style={{
                background: isSaved ? '#16a34a' : '#ef4444',
                color: 'white', padding: '12px 24px', borderRadius: '8px',
                fontWeight: 'bold', border: 'none', cursor: 'pointer', transition: 'background 0.3s'
              }}
            >
