  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative', zIndex: 1, paddingBottom: '40px' }}>
      <header style={{
        ...
        backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.2)', padding: '16px 24px'
      }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            <div style={{
              width: '44px', height: '44px', borderRadius: '14px', background: '#fff', color: '#3498db',
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.3rem', boxShadow: '0 4px 15px rgba(0,0,0,0.2)',
            }}>🧑‍🤝‍🧑</div>
            <div>
              <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '1.4rem', fontWeight: 800, color: '#fff', lineHeight: 1.1 }}>Local Guides</h1>
              <p style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.8)', fontWeight: 500, letterSpacing: '0.5px' }}>HUMAN TOUR DIRECTORY</p>
            </div>
          </div>
          <Link href="/" className="btn-secondary" style={{ padding: '8px 16px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', color: '#fff' }}>Back to Home</Link>
        </div>
      </header>
      ...
      <main style={{ maxWidth: '1100px', margin: '40px auto 0', padding: '0 24px', display: 'flex', flexDirection: 'column', gap: '32px' }}>
        ...
        {/* Planner Header Form */}
        <div className="glass-card animate-fade-in-up" style={{ padding: '32px', background: 'rgba(52, 152, 219, 0.05)', border: '1px solid rgba(52, 152, 219, 0.2)' }}>
          <h2 style={{ fontSize: '1.4rem', color: '#3498db', marginBottom: '8px', fontWeight: 700 }}>Plan Your Perfect Trip</h2>
          ...
          <button onClick={handleAIPlanner} className="btn-primary" style={{ background: '#3498db', color: '#fff', fontSize: '1rem', padding: '14px 28px', border: 'none', width: '100%' }}>
...
${user?.primaryEmailAddress?.emailAddress || ''}`
              ...
              return (
                <div key={guide.id} className="glass-card animate-fade-in-up" style={{ padding: '24px', borderTop: '4px solid #3498db', animationDelay: `${i * 0.1}s`, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <a 
                    ...
                    style={{ textAlign: 'center', display: 'block', padding: '12px', border: '1px solid rgba(52, 152, 219, 0.4)', color: '#3498db', fontWeight: 600, textDecoration: 'none' }}
                  >
                    ✉️ Contact via Gmail
                  </a>
                </div>
